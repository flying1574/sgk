...
if (empty($_GET["keyword"])){
    ...
    <head>
        ...
        <title>匿名者社工库 - 谁泄露了你的信息?</title>
        <meta name="description" content="匿名者社工库 - 谁泄露了你的信息?">
    ...
    <body>
        ...
        <footer id="pagefooter">
            <p class="pull-right">Email:274271731@qq.com<br>©2014 AnonyMosu 所有</p>

        </footer>
    </div> <!-- /container -->
    <script type="text/javascript" src="http://tajs.qq.com/stats?sId=274271731" charset="UTF-8"></script>
</body>
</html>';
}
else
{
    ...
    <body>
        ...
        // elseif ($session['credit'] >= 1) {
            // echo "此结果内部社工库已经获取，是否购买<a href='http://www.hkxsj.com/?keyword=".$search."&buy=yes'>Buy</a>";
    // # code...
        // }
        echo '<div class="hero-unit">';

        $url="http://sgk.hzsvs.cn/svip_so.php?so=".$search."&vip=".$vip ;  
        $cu = curl_init();
